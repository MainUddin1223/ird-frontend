...
const Header = () => {
	return (
		<div className="flex justify-between">
			...
			<div className="w-1/2 xl:w-[630px] flex justify-between">
				<div className="relative ">
					<input
						type="text"
						placeholder="Search by Dua Name"
						className="w-[370px] rounded-[10px] text-base p-4 bg-bgColor "
					/>
					<div className="absolute right-1 top-1 bg-accent w-54 p-3 rounded-md">
